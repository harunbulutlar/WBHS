...
namespace MvcApplication2.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public ActionResult AdminOnly(RegisterModel model)
        {
        ...
        {
            var model = new RegisterModel {Birthday = DateTime.Now};
            return View(model);
        }

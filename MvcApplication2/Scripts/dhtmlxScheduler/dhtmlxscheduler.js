...
window.dhtmlXScheduler = window.scheduler = {
    ...
    function () {
        ...
        function r(e, s, a) {
            ...
            return r.style.top = "top" == e.position ? "-3px" : o + "px",
        ...
        dhtmlxEventable(scheduler), scheduler._detachDomEvent = function (e, t, i) {
            ...
            t = t || scheduler._currentDate(), i = i || "week",
            ...
            this.set_xy(this._els.dhx_cal_navline[0], e, this.xy.nav_height, 0, 0),
                this.set_xy(this._els.dhx_cal_header[0], e - i, this.xy.scale_height, s, this.xy.nav_height + (this._quirks ? -1 : 1));
            ...
            this._obj.onselectstart = null, this._obj.onmousemove = null,
                this._obj.onmousedown = null, this._obj.onmouseup = null, this._obj.ondblclick = null, this._obj.oncontextmenu = null
            ...
            var d = new Date(t);
            n.valueOf() == d.valueOf() && d.setTime(d.valueOf() + a), s.start_date = s.start_date || n, s.end_date = s.end_date || d, s.text = s.text || this.locale.labels.new_event,
                s.id = this._drag_id = this.uid(), this._drag_mode = "new-size", this._loading = !0, this.addEvent(s), this.callEvent("onEventCreated", [this._drag_id, i]), this._loading = !1, this._drag_event = {}, this._on_mouse_up(i)
                ...
                if (t.force_redraw || this._is_pos_changed(this._drag_pos, t)) {
                    ...
                    if (this._drag_pos = t, this._drag_pos.has_moved = !0, "create" == this._drag_mode) {
                        ...
                        var n = new Date(this._drag_start),
                            r = new Date(s);
                        "day" != this._mode && "week" != this._mode || n.getHours() != r.getHours() || n.getMinutes() != r.getMinutes() || (r = new Date(this._drag_start + 1e3)), this._drag_id = this.uid(), this.addEvent(n, r, this.locale.labels.new_event, this._drag_id, t.fields),
            ...
            if (!e || 2 != e.button || !scheduler.config.touch) {
                if (this._drag_mode && this._drag_id) {
                    ...
                    var t = this._drag_id,
                        i = this._drag_mode,
                        s = (this._mouse_coords(e), !this._drag_pos || this._drag_pos.has_moved),
            ...
            week_start: function (e) {
                var t = e.getDay();
                return scheduler.config.start_on_monday && (0 === t ? t = 6 : t--),
            ...
            str_to_date: function (e, t) {
                ...
                t && (n = " Date.UTC(" + n + ")");
                var r = new Function("date", "var set=[0,0,1,0,0,0]; " + i + " return new Date(" + n + ");");

                return scheduler.date._bind_host_object(r)
            },
            ...
            this._events = {}, this._loaded = {}, this._edit_id = null, this._select_id = null, this._drag_id = null, this._drag_mode = null, this._drag_pos = null, this.clear_view(),
            ...
            n.start_date.valueOf() == n.end_date.valueOf() && n.end_date.setTime(n.end_date.valueOf() + r),
            ...
            scheduler._init_touch_events = function () {
                ...
                e._methods = ["_set_event_text_style", "", "changeEventId", "_dp_hook_delete"], this._dp_hook_delete = function (e) {
                    ...
                    var i = this.obj.getEvent(e),
                        s = {};
                    for (var a in i) 0 !== a.indexOf("_") && (s[a] = i[a] && i[a].getUTCFullYear ? this.obj.templates.xml_format(i[a]) : i[a]);
                    return s
                }, e._clearUpdateFlag = function () { }, e.attachEvent("insertCallback", scheduler._update_callback), e.attachEvent("updateCallback", scheduler._update_callback),
            ...
            scheduler._update_callback = function (e, t) {
                ...
                var s = 0;
                if (!scheduler.skin || "classic" !== scheduler.skin && "glossy" !== scheduler.skin || (s = 1), this._configure(scheduler.config, scheduler._skin_settings, s), this._configure(scheduler.xy, scheduler._skin_xy, s),
                        ...
                        return this.each(function () {
                            if (this && this.getAttribute)
                                if (this.getAttribute("dhxscheduler")) a.push(window[this.getAttribute("dhxscheduler")]);
                                    ...
                                    for (var n in s) "data" != n && (i.config[n] = s[n]);
                                    this.getElementsByTagName("div").length || (this.innerHTML = '<div class="dhx_cal_navline"><div class="dhx_cal_prev_button">&nbsp;</div><div class="dhx_cal_next_button">&nbsp;</div><div class="dhx_cal_today_button"></div><div class="dhx_cal_date"></div><div class="dhx_cal_tab" name="day_tab" style="right:204px;"></div><div class="dhx_cal_tab" name="week_tab" style="right:140px;"></div><div class="dhx_cal_tab" name="month_tab" style="right:76px;"></div></div><div class="dhx_cal_header"></div><div class="dhx_cal_data"></div>',
                                        this.className += " dhx_cal_container"), i.init(this, i.config.date, i.config.mode), s.data && i.parse(s.data), a.push(i), t++
                                }
                        }), 1 === a.length ? a[0] : a
                    }
                    return i[s] ? i[s].apply(this, []) : void e.error("Method " + s + " does not exist on jQuery.dhx_scheduler")
                }
            }(jQuery),
            function () {
                function e(e, t, i) {
                ...
                var t = scheduler.setCurrentView,
                    ...
                    n = function (t, n) {
                        ...
                        window.clearTimeout(a), window.clearTimeout(s), e(this, t, n), a = setTimeout(function () {
                            r.callEvent("onBeforeViewChange", [r._mode, r._date, n || r._mode, t || r._date]) && (i.call(r, t, n),
                                r.callEvent("onViewChange", [r._mode, r._date]), window.clearTimeout(s), a = 0)
    ...
    }, window.scheduler = Scheduler.getSchedulerInstance(), dhtmlx && dhtmlx.attaches && (dhtmlx.attaches.attachScheduler = function (e, t, i, s) {

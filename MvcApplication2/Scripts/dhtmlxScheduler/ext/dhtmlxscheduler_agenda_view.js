...
l.style.height=o.offsetHeight<e._els.dhx_cal_data[0].offsetHeight?"100%":o.offsetHeight+"px";var h=e._els.dhx_cal_data[0].firstChild.childNodes;e._els.dhx_cal_date[0].innerHTML=e.templates.agenda_date(e._min_date,e._max_date,e._mode),e._rendered=[];for(var s=0;s<h.length-1;s++)e._rendered[s]=h[s]}var s=e.dblclick_dhx_cal_data;e.dblclick_dhx_cal_data=function(){if("agenda"==this._mode)!this.config.readonly&&this.config.dblclick_create&&this.addEventNow();else if(s)return s.apply(this,arguments)},e.attachEvent("onSchedulerResize",function(){
